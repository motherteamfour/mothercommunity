<template>
  <div>
    <div class="top">
      ...
      <button type="button" class="seek-btn btn" @click="search">搜索</button>
      <button type="button" class="del-btn btn" @click="delAll">删除</button>
      <button type="button" class="recover btn" @click="resumes">恢复</button>
    </div>
    <el-table
      ref="multipleTable"
      :data="tableData"
